# Generated by Django 5.2.8 on 2026-02-27 09:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('patient', 'Patient'), ('doctor', 'Doctor'), ('clinic_admin', 'Clinic Admin'), ('super_admin', 'Super Admin')], default='patient', max_length=20)),
                ...
                ('preferred_language', models.CharField(default='ur', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('admin', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='accounts_managed_clinics', to=settings.AUTH_USER_MODEL)),
                ('doctors', models.ManyToManyField(related_name='clinics', to='accounts.doctorprofile')),
            ],
        ),
        migrations.CreateModel(
            name='PatientProfile',
