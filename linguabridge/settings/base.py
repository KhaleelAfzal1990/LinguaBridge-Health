...
WSGI_APPLICATION = 'linguabridge.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.getenv('DB_PASSWORD', 'alliswell786.'),
...
# Default AI provider
DEFAULT_AI_PROVIDER = os.getenv('DEFAULT_AI_PROVIDER', 'deepseek')  # openai, deepseek, anthropic, gemini